...
CLIENT_SECRET_FILE = "/root/blablabla/client_secret.json" #Ganti lokasi client_secret.json disini
TOKEN_FILE = "/root/blablabla/token.json" #Ganti lokasi token.json file disini
CONFIG_FILE = "/root/blablabla/config.json" #Ganti config.json file disini
